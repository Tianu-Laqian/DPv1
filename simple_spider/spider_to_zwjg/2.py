...
# 各地区主页 URL 列表
region_pages = [
    'https://www.mfa.gov.cn/web/zwjg_674741/zwzlg_674757/yz_674759/',    # 亚洲
    'https://www.mfa.gov.cn/web/zwjg_674741/zwzlg_674757/fz_674761/',    # 非洲
    'https://www.mfa.gov.cn/web/zwjg_674741/zwzlg_674757/xo_674763/',    # 欧洲
    'https://www.mfa.gov.cn/web/zwjg_674741/zwzlg_674757/xybf_674765/',  # 北美洲
    'https://www.mfa.gov.cn/web/zwjg_674741/zwzlg_674757/dozy_674767/',  # 南美洲
    'https://www.mfa.gov.cn/web/zwjg_674741/zwzlg_674757/bmdyz_674769/'  # 大洋洲
]

# CSV 文件头
csv_file = 'zhuwaizong.csv'
with open(csv_file, 'w', newline='', encoding='utf-8-sig') as f:
    writer = csv.writer(f)
    writer.writerow(['地区','国家', '机构', '姓名', '职务', 'url'])
    ...
    try:
        ...
        for href in hrefs:
            ...
            try:
                ...
                # 获取机构名和国家名
                con_inst = t2.xpath('/html/body/div[4]/div[2]/div/div[1]/h1/text()')
                con_inst = con_inst[0].strip() if con_inst else ''
                llist = con_inst.split("（")
                country = llist[1].replace('）','')
                inst = llist[0]
                ...
                with open(csv_file, 'a', newline='', encoding='utf-8-sig') as f:
                    writer = csv.writer(f)
                    writer.writerow([region_name, country,inst, name, duty, full_url])
