...
def process_under40_cn_json_to_csv(json_file_path, output_csv_path):
    """
...
if __name__ == "__main__":
    input_json  = "2024年胡润Under40s中国创业先锋.json"  # 替换成你的文件名
    ts = time.strftime("%Y%m%d%H%M%S")
    output_csv = f"2024年胡润Under40s中国创业先锋_{ts}.csv"
    process_under40_cn_json_to_csv(input_json, output_csv)
